...
public class Messages extends RecyclerView.Adapter<Messages.ViewHolder> {
     ...
     */
    public Messages(Context mContext, List<Chat> mChat, String imageURL)
    {
        this.mChat    = mChat;
    ...
    @Override
    public Messages.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        if ( viewType == MSG_TYPE_RIGHT)
        {
            View view = LayoutInflater.from(mContext).inflate(R.layout.ChatReciever, parent, false);
            return new Messages.ViewHolder(view);
        }
        else
        {
            View view = LayoutInflater.from(mContext).inflate(R.layout.ChatSender, parent, false);
            return new Messages.ViewHolder(view);
        }
    }

    @Override
    public void onBindViewHolder(Messages.ViewHolder holder, int position)
    {
