            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(textUsername) || TextUtils.isEmpty(textEmail) || TextUtils.isEmpty(textPassword)){
                    ...
                    auth.createUserWithEmailAndPassword(textEmail, textPassword)
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(SignUp.this, "Could not upload image", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText( SignUp.this, "Could not upload " + e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
